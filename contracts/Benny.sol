...
contract Benny is ERC20 {
    uint constant _initial_supply = 8964 * (10**18);  // setting variable for how many of your own tokens are initially put into your wallet, feel free to edit the first number but make sure to leave the second number because we want to make sure our supply has 18 decimals
    ...
    constructor() ERC20("Benny", "Benny") public {
